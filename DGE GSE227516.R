...
# Import Gene Counts
COUNTS <- read.csv(file="D:/DOWNLOADS/dge_analysis_using_DESeq2-main/dge_analysis_using_DESeq2-main/data/GSE227516_counts.csv", header=TRUE, row.names=1)
head(COUNTS)


## -----------------------------------------------------------------------------
# Import Sample Information
META <- read.csv(file="D:/DOWNLOADS/dge_analysis_using_DESeq2-main/dge_analysis_using_DESeq2-main/data/sample_information.csv", header=TRUE)
head(META)
